...
CREATE TABLE IF NOT EXISTS `dbtickets`.`acceso` (
  ...
  INDEX `fk_acceso_modulo_idx` (`id_modulo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`acceso_perfil` (
  ...
  INDEX `fk_acceso_perfil_acceso1_idx` (`id_acceso` ASC) VISIBLE,
  INDEX `fk_acceso_perfil_perfil1_idx` (`id_perfil` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`acceso_usuario` (
  ...
  INDEX `fk_acceso_usuario_acceso1_idx` (`id_acceso` ASC) VISIBLE,
  INDEX `fk_acceso_usuario_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`ticket` (
  ...
  INDEX `fk_ticket_categoria1_idx` (`id_categoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`perfil_ticket` (
  ...
  INDEX `fk_perfil_ticket_ticket1_idx` (`id_ticket` ASC) VISIBLE,
  INDEX `fk_perfil_ticket_perfil1_idx` (`id_perfil` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`usuario_ticket` (
  ...
  INDEX `fk_usuario_ticket_ticket1_idx` (`id_ticket` ASC) VISIBLE,
  INDEX `fk_usuario_ticket_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`ticket_realizado` (
  ...
  INDEX `fk_ticket_realizado_ticket1_idx` (`id_ticket` ASC) VISIBLE,
  INDEX `fk_ticket_realizado_usuario1_idx` (`id_usuario` ASC) VISIBLE,
  INDEX `fk_ticket_realizado_usuario2_idx` (`id_usuario_destino` ASC) VISIBLE,
  INDEX `fk_ticket_realizado_departamento1_idx` (`id_departamento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`tcket_fase` (
  ...
  INDEX `fk_tcket_fase_fase1_idx` (`id_fase` ASC) VISIBLE,
  INDEX `fk_tcket_fase_ticket_realizado1_idx` (`id_ticket_realizado` ASC) VISIBLE,
  INDEX `fk_tcket_fase_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`mensaje` (
  ...
  INDEX `fk_mensaje_ticket_realizado1_idx` (`id_ticket_realizado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`notificacion` (
  ...
  INDEX `fk_notificacion_ticket_realizado1_idx` (`id_ticket_realizado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`usuario_departamento` (
  ...
  INDEX `fk_usuario_departamento_departamento1_idx` (`id_departamento` ASC) VISIBLE,
  INDEX `fk_usuario_departamento_usuario1_idx` (`id_usuario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`pregunta_categoria` (
  ...
  INDEX `fk_pregunta_categoria_pregunta1_idx` (`id_pregunta` ASC) VISIBLE,
  INDEX `fk_pregunta_categoria_categoria1_idx` (`id_categoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`calificacion` (
  ...
  INDEX `fk_calificacion_ticket_realizado1_idx` (`id_ticket_realizado` ASC) VISIBLE,
  INDEX `fk_calificacion_pregunta_categoria1_idx` (`id_pregunta_categoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`archivo` (
  ...
  INDEX `fk_archivo_ticket_realizado1_idx` (`id_ticket_realizado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `dbtickets`.`historial` (
  ...
  INDEX `fk_historial_usuario1_idx` (`id_usuario` ASC) VISIBLE,
